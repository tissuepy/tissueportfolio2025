...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:va,depthTest:!1,depthWrite:!1})}function _R(r,e,i){const s=new Float32Array(Us),l=new le(0,1,0);return new Mi({name:"SphericalGaussianBlur",defines:{n:Us,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:lu(),fragmentShader:`
	...
	`}class t_ extends Bi{constructor(e=1,i={}){super(e,e,i),this.isWebGLCubeRenderTarget=!0;const s={width:e,height:e,depth:1},l=[s,s,s,s,s,s];this.texture=new Kx(l),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const s={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),p=new Gi(m,g),x=new pp(-1,1,1,-1,0,1);let _=null,v=null,b=!1,M,C=null,S=[],y=!1;this.setSize=function(N,D){c.setSize(N,D),d.setSize(N,D);for(let L=0;L<S.length;L++){const F=S[L];F.setSize&&F.setSize(N,D)}},this.setEffects=function(N){S=N,y=S.length>0&&S[0].isRenderPass===!0;const D=c.width,L=c.height;for(let F=0;F<S.length;F++){const H=S[F];H.setSize&&H.setSize(D,L)}},this.begin=function(N,D){if(b||N.toneMapping===Fi&&S.length===0)return!1;if(C=D,D!==null){const L=D.width,F=D.height;(c.width!==L||c.height!==F)&&this.setSize(L,F)}return y===!1&&N.setRenderTarget(c),M=N.toneMapping,N.toneMapping=Fi,!0},this.hasRenderPass=function(){return y},this.end=function(N,D){N.toneMapping=M,b=!0;let L=c,F=d;for(let H=0;H<S.length;H++){const G=S[H];if(G.enabled!==!1&&(G.render(N,F,L,D),G.needsSwap!==!1)){const A=L;L=F,F=A}}if(_!==N.outputColorSpace||v!==N.toneMapping){_=N.outputColorSpace,v=N.toneMapping,g.defines={},bt.getTransfer(_)===Ft&&(g.defines.SRGB_TRANSFER="");const H=wR[v];H&&(g.defines[H]=""),g.needsUpdate=!0}g.uniforms.tDiffuse.value=L.texture,N.setRenderTarget(C),N.render(p,x),C=null,b=!1},this.isCompositing=function(){return b},this.dispose=function(){c.dispose(),d.dispose(),m.dispose(),g.dispose()}}const n_=new Pn,Yh=new tl(1,1),i_=new kx,a_=new JT,s_=new Kx,Xv=[],Wv=[],qv=new Float32Array(16),Yv=new Float32Array(9),Zv=new Float32Array(4);function Vr(r,e,i){const s=r[0];if(s<=0||s>0)return r;const l=e*i;let c=Xv[l];if(c===void 0&&(c=new Float32Array(l),Xv[l]=c),e!==0){s.toArray(c,0);for(let d=1,m=0;d!==e;++d)m+=i,r[d].toArray(c,m)}return c}function mn(r,e){if(r.length!==e.length)return!1;for(let i=0,s=r.length;i<s;i++)if(r[i]!==e[i])return!1;return!0}function gn(r,e){for(let i=0,s=e.length;i<s;i++)r[i]=e[i]}function cu(r,e){let i=Wv[e];i===void 0&&(i=new Int32Array(e),Wv[e]=i);for(let s=0;s!==e;++s)i[s]=r.allocateTextureUnit();return i}function CR(r,e){const i=this.cache;i[0]!==e&&(r.uniform1f(this.addr,e),i[0]=e)}function NR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2f(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(mn(i,e))return;r.uniform2fv(this.addr,e),gn(i,e)}}function DR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3f(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else if(e.r!==void 0)(i[0]!==e.r||i[1]!==e.g||i[2]!==e.b)&&(r.uniform3f(this.addr,e.r,e.g,e.b),i[0]=e.r,i[1]=e.g,i[2]=e.b);else{if(mn(i,e))return;r.uniform3fv(this.addr,e),gn(i,e)}}function UR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(mn(i,e))return;r.uniform4fv(this.addr,e),gn(i,e)}}function LR(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(mn(i,e))return;r.uniformMatrix2fv(this.addr,!1,e),gn(i,e)}else{if(mn(i,s))return;Zv.set(s),r.uniformMatrix2fv(this.addr,!1,Zv),gn(i,s)}}function OR(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(mn(i,e))return;r.uniformMatrix3fv(this.addr,!1,e),gn(i,e)}else{if(mn(i,s))return;Yv.set(s),r.uniformMatrix3fv(this.addr,!1,Yv),gn(i,s)}}function PR(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(mn(i,e))return;r.uniformMatrix4fv(this.addr,!1,e),gn(i,e)}else{if(mn(i,s))return;qv.set(s),r.uniformMatrix4fv(this.addr,!1,qv),gn(i,s)}}function IR(r,e){const i=this.cache;i[0]!==e&&(r.uniform1i(this.addr,e),i[0]=e)}function FR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2i(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(mn(i,e))return;r.uniform2iv(this.addr,e),gn(i,e)}}function BR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3i(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(mn(i,e))return;r.uniform3iv(this.addr,e),gn(i,e)}}function zR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(mn(i,e))return;r.uniform4iv(this.addr,e),gn(i,e)}}function HR(r,e){const i=this.cache;i[0]!==e&&(r.uniform1ui(this.addr,e),i[0]=e)}function jR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2ui(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(mn(i,e))return;r.uniform2uiv(this.addr,e),gn(i,e)}}function GR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3ui(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(mn(i,e))return;r.uniform3uiv(this.addr,e),gn(i,e)}}function kR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(mn(i,e))return;r.uniform4uiv(this.addr,e),gn(i,e)}}function VR(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l);let c;this.type===r.SAMPLER_2D_SHADOW?(Yh.compareFunction=i.isReversedDepthBuffer()?fp:up,c=Yh):c=n_,i.setTexture2D(e||c,l)}function XR(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture3D(e||a_,l)}function WR(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTextureCube(e||s_,l)}function qR(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture2DArray(e||i_,l)}function YR(r){switch(r){case 5126:return CR;case 35664:return NR;case 35665:return DR;case 35666:return UR;case 35674:return LR;case 35675:return OR;case 35676:return PR;case 5124:case 35670:return IR;case 35667:case 35671:return FR;case 35668:case 35672:return BR;case 35669:case 35673:return zR;case 5125:return HR;case 36294:return jR;case 36295:return GR;case 36296:return kR;case 35678:case 36198:case 36298:case 36306:case 35682:return VR;case 35679:case 36299:case 36307:return XR;case 35680:case 36300:case 36308:case 36293:return WR;case 36289:case 36303:case 36311:case 36292:return qR}}function ZR(r,e){r.uniform1fv(this.addr,e)}function KR(r,e){const i=Vr(e,this.size,2);r.uniform2fv(this.addr,i)}function QR(r,e){const i=Vr(e,this.size,3);r.uniform3fv(this.addr,i)}function JR(r,e){const i=Vr(e,this.size,4);r.uniform4fv(this.addr,i)}function $R(r,e){const i=Vr(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,i)}function eC(r,e){const i=Vr(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,i)}function tC(r,e){const i=Vr(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,i)}function nC(r,e){r.uniform1iv(this.addr,e)}function iC(r,e){r.uniform2iv(this.addr,e)}function aC(r,e){r.uniform3iv(this.addr,e)}function sC(r,e){r.uniform4iv(this.addr,e)}function rC(r,e){r.uniform1uiv(this.addr,e)}function oC(r,e){r.uniform2uiv(this.addr,e)}function lC(r,e){r.uniform3uiv(this.addr,e)}function cC(r,e){r.uniform4uiv(this.addr,e)}function uC(r,e,i){const s=this.cache,l=e.length,c=cu(i,l);mn(s,c)||(r.uniform1iv(this.addr,c),gn(s,c));let d;this.type===r.SAMPLER_2D_SHADOW?d=Yh:d=n_;for(let m=0;m!==l;++m)i.setTexture2D(e[m]||d,c[m])}function fC(r,e,i){const s=this.cache,l=e.length,c=cu(i,l);mn(s,c)||(r.uniform1iv(this.addr,c),gn(s,c));for(let d=0;d!==l;++d)i.setTexture3D(e[d]||a_,c[d])}function dC(r,e,i){const s=this.cache,l=e.length,c=cu(i,l);mn(s,c)||(r.uniform1iv(this.addr,c),gn(s,c));for(let d=0;d!==l;++d)i.setTextureCube(e[d]||s_,c[d])}function hC(r,e,i){const s=this.cache,l=e.length,c=cu(i,l);mn(s,c)||(r.uniform1iv(this.addr,c),gn(s,c));for(let d=0;d!==l;++d)i.setTexture2DArray(e[d]||i_,c[d])}function pC(r){switch(r){case 5126:return ZR;case 35664:return KR;case 35665:return QR;case 35666:return JR;case 35674:return $R;case 35675:return eC;case 35676:return tC;case 5124:case 35670:return nC;case 35667:case 35671:return iC;case 35668:case 35672:return aC;case 35669:case 35673:return sC;case 5125:return rC;case 36294:return oC;case 36295:return lC;case 36296:return cC;case 35678:case 36198:case 36298:case 36306:case 35682:return uC;case 35679:case 36299:case 36307:return fC;case 35680:case 36300:case 36308:case 36293:return dC;case 36289:case 36303:case 36311:case 36292:return hC}}class mC{constructor(e,i,s){this.id=e,this.addr=s,this.cache=[],this.type=i.type,this.setValue=YR(i.type)}}class gC{constructor(e,i,s){this.id=e,this.addr=s,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=pC(i.type)}}class vC{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,i,s){const l=this.seq;for(let c=0,d=l.length;c!==d;++c){const m=l[c];m.setValue(e,i[m.id],s)}}}const $d=/(\w+)(\])?(\[|\.)?/g;function Kv(r,e){r.seq.push(e),r.map[e.id]=e}function xC(r,e,i){const s=r.name,l=s.length;for($d.lastIndex=0;;){const c=$d.exec(s),d=$d.lastIndex;let m=c[1];const g=c[2]==="]",p=c[3];if(g&&(m=m|0),p===void 0||p==="["&&d+2===l){Kv(i,p===void 0?new mC(m,r,e):new gC(m,r,e));break}else{let _=i.map[m];_===void 0&&(_=new vC(m),Kv(i,_)),i=_}}}class Jc{constructor(e,i){this.seq=[],this.map={};const s=e.getProgramParameter(i,e.ACTIVE_UNIFORMS);for(let d=0;d<s;++d){const m=e.getActiveUniform(i,d),g=e.getUniformLocation(i,m.name);xC(m,g,this)}const l=[],c=[];for(const d of this.seq)d.type===e.SAMPLER_2D_SHADOW||d.type===e.SAMPLER_CUBE_SHADOW||d.type===e.SAMPLER_2D_ARRAY_SHADOW?l.push(d):c.push(d);l.length>0&&(this.seq=l.concat(c))}setValue(e,i,s,l){const c=this.map[i];c!==void 0&&c.setValue(e,s,l)}setOptional(e,i,s){const l=i[s];l!==void 0&&this.setValue(e,s,l)}static upload(e,i,s,l){for(let c=0,d=i.length;c!==d;++c){const m=i[c],g=s[m.id];g.needsUpdate!==!1&&m.setValue(e,g.value,l)}}static seqWithValue(e,i){const s=[];for(let l=0,c=e.length;l!==c;++l){const d=e[l];d.id in i&&s.push(d)}return s}}function Qv(r,e,i){const s=r.createShader(e);return r.shaderSource(s,i),r.compileShader(s),s}const _C=37297;let yC=0;function SC(r,e){const i=r.split(`
`),s=[],l=Math.max(e-6,0),c=Math.min(e+6,i.length);for(let d=l;d<c;d++){const m=d+1;s.push(`${m===e?">":" "} ${m}: ${i[d]}`)}return s.join(`
`)}const Jv=new ut;function bC(r){bt._getMatrix(Jv,bt.workingColorSpace,r);const e=`mat3( ${Jv.elements.map(i=>i.toFixed(4))} )`;switch(bt.getTransfer(r)){case eu:return[e,"LinearTransferOETF"];case Ft:return[e,"sRGBTransferOETF"];default:return at("WebGLProgram: Unsupported color space: ",r),[e,"LinearTransferOETF"]}}function $v(r,e,i){const s=r.getShaderParameter(e,r.COMPILE_STATUS),c=(r.getShaderInfoLog(e)||"").trim();if(s&&c==="")return"";const d=/ERROR: 0:(\d+)/.exec(c);if(d){const m=parseInt(d[1]);return i.toUpperCase()+`

`+c+`

`+SC(r.getShaderSource(e),m)}else return c}function MC(r,e){const i=bC(e);return[`vec4 ${r}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}const EC={[wx]:"Linear",[Rx]:"Reinhard",[Cx]:"Cineon",[Nx]:"ACESFilmic",[Ux]:"AgX",[Lx]:"Neutral",[Dx]:"Custom"};function TC(r,e){const i=EC[e];return i===void 0?(at("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Vc=new le;function AC(){bt.getLuminanceCoefficients(Vc);const r=Vc.x.toFixed(4),e=Vc.y.toFixed(4),i=Vc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function wC(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Qo).join(`
`)}function RC(r){const e=[];for(const i in r){const s=r[i];s!==!1&&e.push("#define "+i+" "+s)}return e.join(`
`)}function CC(r,e){const i={},s=r.getProgramParameter(e,r.ACTIVE_ATTRIBUTES);for(let l=0;l<s;l++){const c=r.getActiveAttrib(e,l),d=c.name;let m=1;c.type===r.FLOAT_MAT2&&(m=2),c.type===r.FLOAT_MAT3&&(m=3),c.type===r.FLOAT_MAT4&&(m=4),i[d]={type:c.type,location:r.getAttribLocation(e,d),locationSize:m}}return i}function Qo(r){return r!==""}function ex(r,e){const i=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function tx(r,e){return r.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const NC=/^[ \t]*#include +<([\w\d./]+)>/gm;function Zh(r){return r.replace(NC,UC)}const DC=new Map;function UC(r,e){let i=ft[e];if(i===void 0){const s=DC.get(e);if(s!==void 0)i=ft[s],at('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,s);else throw new Error("Can not resolve #include <"+e+">")}return Zh(i)}const LC=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function nx(r){return r.replace(LC,OC)}function OC(r,e,i,s){let l="";for(let c=parseInt(e);c<parseInt(i);c++)l+=s.replace(/\[\s*i\s*\]/g,"[ "+c+" ]").replace(/UNROLLED_LOOP_INDEX/g,c);return l}function ix(r){let e=`precision ${r.precision} float;
...
#define LOW_PRECISION`),e}const PC={[qc]:"SHADOWMAP_TYPE_PCF",[Ko]:"SHADOWMAP_TYPE_VSM"};function IC(r){return PC[r.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const FC={[Ps]:"ENVMAP_TYPE_CUBE",[Ir]:"ENVMAP_TYPE_CUBE",[ru]:"ENVMAP_TYPE_CUBE_UV"};function BC(r){return r.envMap===!1?"ENVMAP_TYPE_CUBE":FC[r.envMapMode]||"ENVMAP_TYPE_CUBE"}const zC={[Ir]:"ENVMAP_MODE_REFRACTION"};function HC(r){return r.envMap===!1?"ENVMAP_MODE_REFLECTION":zC[r.envMapMode]||"ENVMAP_MODE_REFLECTION"}const jC={[Ax]:"ENVMAP_BLENDING_MULTIPLY",[NT]:"ENVMAP_BLENDING_MIX",[DT]:"ENVMAP_BLENDING_ADD"};function GC(r){return r.envMap===!1?"ENVMAP_BLENDING_NONE":jC[r.combine]||"ENVMAP_BLENDING_NONE"}function kC(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,s=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),7*16)),texelHeight:s,maxMip:i}}function VC(r,e,i,s){const l=r.getContext(),c=i.defines;let d=i.vertexShader,m=i.fragmentShader;const g=IC(i),p=BC(i),x=HC(i),_=GC(i),v=kC(i),b=wC(i),M=RC(c),C=l.createProgram();let S,y,N=i.glslVersion?"#version "+i.glslVersion+`
