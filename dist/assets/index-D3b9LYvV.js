 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var I0;function ZS(){if(I0)return ct;I0=1;var r=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),f=Symbol.for("react.context"),p=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),S=Symbol.iterator;function v(O){return O===null||typeof O!="object"?null:(O=S&&O[S]||O["@@iterator"],typeof O=="function"?O:null)}var M={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,w={};function y(O,K,ue){this.props=O,this.context=K,this.refs=w,this.updater=ue||M}y.prototype.isReactComponent={},y.prototype.setState=function(O,K){if(typeof O!="object"&&typeof O!="function"&&O!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,O,K,"setState")},y.prototype.forceUpdate=function(O){this.updater.enqueueForceUpdate(this,O,"forceUpdate")};function x(){}x.prototype=y.prototype;function N(O,K,ue){this.props=O,this.context=K,this.refs=w,this.updater=ue||M}var D=N.prototype=new x;D.constructor=N,E(D,y.prototype),D.isPureReactComponent=!0;var L=Array.isArray,F={H:null,A:null,T:null,S:null,V:null},H=Object.prototype.hasOwnProperty;function V(O,K,ue,Se,Ue,qe){return ue=qe.ref,{$$typeof:r,type:O,key:K,ref:ue!==void 0?ue:null,props:qe}}function A(O,K){return V(O.type,K,void 0,void 0,void 0,O.props)}function U(O){return typeof O=="object"&&O!==null&&O.$$typeof===r}function fe(O){var K={"=":"=0",":":"=2"};return"$"+O.replace(/[=:]/g,function(ue){return K[ue]})}var G=/\/+/g;function ee(O,K){return typeof O=="object"&&O!==null&&O.key!=null?fe(""+O.key):K.toString(36)}function re(){}function de(O){switch(O.status){case"fulfilled":return O.value;case"rejected":throw O.reason;default:switch(typeof O.status=="string"?O.then(re,re):(O.status="pending",O.then(function(K){O.status==="pending"&&(O.status="fulfilled",O.value=K)},function(K){O.status==="pending"&&(O.status="rejected",O.reason=K)})),O.status){case"fulfilled":return O.value;case"rejected":throw O.reason}}throw O}function Z(O,K,ue,Se,Ue){var qe=typeof O;(qe==="undefined"||qe==="boolean")&&(O=null);var te=!1;if(O===null)te=!0;else switch(qe){case"bigint":case"string":case"number":te=!0;break;case"object":switch(O.$$typeof){case r:case e:te=!0;break;case _:return te=O._init,Z(te(O._payload),K,ue,Se,Ue)}}if(te)return Ue=Ue(O),te=Se===""?"."+ee(O,0):Se,L(Ue)?(ue="",te!=null&&(ue=te.replace(G,"$&/")+"/"),Z(Ue,K,ue,"",function(Je){return Je})):Ue!=null&&(U(Ue)&&(Ue=A(Ue,ue+(Ue.key==null||O&&O.key===Ue.key?"":(""+Ue.key).replace(G,"$&/")+"/")+te)),K.push(Ue)),1;te=0;var be=Se===""?".":Se+":";if(L(O))for(var Me=0;Me<O.length;Me++)Se=O[Me],qe=be+ee(Se,Me),te+=Z(Se,K,ue,qe,Ue);else if(Me=v(O),typeof Me=="function")for(O=Me.call(O),Me=0;!(Se=O.next()).done;)Se=Se.value,qe=be+ee(Se,Me++),te+=Z(Se,K,ue,qe,Ue);else if(qe==="object"){if(typeof O.then=="function")return Z(de(O),K,ue,Se,Ue);throw K=String(O),Error("Objects are not valid as a React child (found: "+(K==="[object Object]"?"object with keys {"+Object.keys(O).join(", ")+"}":K)+"). If you meant to render a collection of children, use an array instead.")}return te}function I(O,K,ue){if(O==null)return O;var Se=[],Ue=0;return Z(O,Se,"","",function(qe){return K.call(ue,qe,Ue++)}),Se}function B(O){if(O._status===-1){var K=O._result;K=K(),K.then(function(ue){(O._status===0||O._status===-1)&&(O._status=1,O._result=ue)},function(ue){(O._status===0||O._status===-1)&&(O._status=2,O._result=ue)}),O._status===-1&&(O._status=0,O._result=K)}if(O._status===1)return O._result.default;throw O._result}var ae=typeof reportError=="function"?reportError:function(O){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var K=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof O=="object"&&O!==null&&typeof O.message=="string"?String(O.message):String(O),error:O});if(!window.dispatchEvent(K))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",O);return}console.error(O)};function ge(){}return ct.Children={map:I,forEach:function(O,K,ue){I(O,function(){K.apply(this,arguments)},ue)},count:function(O){var K=0;return I(O,function(){K++}),K},toArray:function(O){return I(O,function(K){return K})||[]},only:function(O){if(!U(O))throw Error("React.Children.only expected to receive a single React element child.");return O}},ct.Component=y,ct.Fragment=i,ct.Profiler=l,ct.PureComponent=N,ct.StrictMode=s,ct.Suspense=m,ct.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=F,ct.__COMPILER_RUNTIME={__proto__:null,c:function(O){return F.H.useMemoCache(O)}},ct.cache=function(O){return function(){return O.apply(null,arguments)}},ct.cloneElement=function(O,K,ue){if(O==null)throw Error("The argument must be a React element, but you passed "+O+".");var Se=E({},O.props),Ue=O.key,qe=void 0;if(K!=null)for(te in K.ref!==void 0&&(qe=void 0),K.key!==void 0&&(Ue=""+K.key),K)!H.call(K,te)||te==="key"||te==="__self"||te==="__source"||te==="ref"&&K.ref===void 0||(Se[te]=K[te]);var te=arguments.length-2;if(te===1)Se.children=ue;else if(1<te){for(var be=Array(te),Me=0;Me<te;Me++)be[Me]=arguments[Me+2];Se.children=be}return V(O.type,Ue,void 0,void 0,qe,Se)},ct.createContext=function(O){return O={$$typeof:f,_currentValue:O,_currentValue2:O,_threadCount:0,Provider:null,Consumer:null},O.Provider=O,O.Consumer={$$typeof:c,_context:O},O},ct.createElement=function(O,K,ue){var Se,Ue={},qe=null;if(K!=null)for(Se in K.key!==void 0&&(qe=""+K.key),K)H.call(K,Se)&&Se!=="key"&&Se!=="__self"&&Se!=="__source"&&(Ue[Se]=K[Se]);var te=arguments.length-2;if(te===1)Ue.children=ue;else if(1<te){for(var be=Array(te),Me=0;Me<te;Me++)be[Me]=arguments[Me+2];Ue.children=be}if(O&&O.defaultProps)for(Se in te=O.defaultProps,te)Ue[Se]===void 0&&(Ue[Se]=te[Se]);return V(O,qe,void 0,void 0,null,Ue)},ct.createRef=function(){return{current:null}},ct.forwardRef=function(O){return{$$typeof:p,render:O}},ct.isValidElement=U,ct.lazy=function(O){return{$$typeof:_,_payload:{_status:-1,_result:O},_init:B}},ct.memo=function(O,K){return{$$typeof:h,type:O,compare:K===void 0?null:K}},ct.startTransition=function(O){var K=F.T,ue={};F.T=ue;try{var Se=O(),Ue=F.S;Ue!==null&&Ue(ue,Se),typeof Se=="object"&&Se!==null&&typeof Se.then=="function"&&Se.then(ge,ae)}catch(qe){ae(qe)}finally{F.T=K}},ct.unstable_useCacheRefresh=function(){return F.H.useCacheRefresh()},ct.use=function(O){return F.H.use(O)},ct.useActionState=function(O,K,ue){return F.H.useActionState(O,K,ue)},ct.useCallback=function(O,K){return F.H.useCallback(O,K)},ct.useContext=function(O){return F.H.useContext(O)},ct.useDebugValue=function(){},ct.useDeferredValue=function(O,K){return F.H.useDeferredValue(O,K)},ct.useEffect=function(O,K,ue){var Se=F.H;if(typeof ue=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return Se.useEffect(O,K)},ct.useId=function(){return F.H.useId()},ct.useImperativeHandle=function(O,K,ue){return F.H.useImperativeHandle(O,K,ue)},ct.useInsertionEffect=function(O,K){return F.H.useInsertionEffect(O,K)},ct.useLayoutEffect=function(O,K){return F.H.useLayoutEffect(O,K)},ct.useMemo=function(O,K){return F.H.useMemo(O,K)},ct.useOptimistic=function(O,K){return F.H.useOptimistic(O,K)},ct.useReducer=function(O,K,ue){return F.H.useReducer(O,K,ue)},ct.useRef=function(O){return F.H.useRef(O)},ct.useState=function(O){return F.H.useState(O)},ct.useSyncExternalStore=function(O,K,ue){return F.H.useSyncExternalStore(O,K,ue)},ct.useTransition=function(){return F.H.useTransition()},ct.version="19.1.0",ct}var F0;function Wh(){return F0||(F0=1,ud.exports=ZS()),ud.exports}var $=Wh();const KS=Yv($);var fd={exports:{}},Fo={},dd={exports:{}},hd={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var B0;function QS(){return B0||(B0=1,function(r){function e(I,B){var ae=I.length;I.push(B);e:for(;0<ae;){var ge=ae-1>>>1,O=I[ge];if(0<l(O,B))I[ge]=B,I[ae]=O,ae=ge;else break e}}function i(I){return I.length===0?null:I[0]}function s(I){if(I.length===0)return null;var B=I[0],ae=I.pop();if(ae!==B){I[0]=ae;e:for(var ge=0,O=I.length,K=O>>>1;ge<K;){var ue=2*(ge+1)-1,Se=I[ue],Ue=ue+1,qe=I[Ue];if(0>l(Se,ae))Ue<O&&0>l(qe,Se)?(I[ge]=qe,I[Ue]=ae,ge=Ue):(I[ge]=Se,I[ue]=ae,ge=ue);else if(Ue<O&&0>l(qe,ae))I[ge]=qe,I[Ue]=ae,ge=Ue;else break e}}return B}function l(I,B){var ae=I.sortIndex-B.sortIndex;return ae!==0?ae:I.id-B.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var f=Date,p=f.now();r.unstable_now=function(){return f.now()-p}}var m=[],h=[],_=1,S=null,v=3,M=!1,E=!1,w=!1,y=!1,x=typeof setTimeout=="function"?setTimeout:null,N=typeof clearTimeout=="function"?clearTimeout:null,D=typeof setImmediate<"u"?setImmediate:null;function L(I){for(var B=i(h);B!==null;){if(B.callback===null)s(h);else if(B.startTime<=I)s(h),B.sortIndex=B.expirationTime,e(m,B);else break;B=i(h)}}function F(I){if(w=!1,L(I),!E)if(i(m)!==null)E=!0,H||(H=!0,ee());else{var B=i(h);B!==null&&Z(F,B.startTime-I)}}var H=!1,V=-1,A=5,U=-1;function fe(){return y?!0:!(r.unstable_now()-U<A)}function G(){if(y=!1,H){var I=r.unstable_now();U=I;var B=!0;try{e:{E=!1,w&&(w=!1,N(V),V=-1),M=!0;var ae=v;try{t:{for(L(I),S=i(m);S!==null&&!(S.expirationTime>I&&fe());){var ge=S.callback;if(typeof ge=="function"){S.callback=null,v=S.priorityLevel;var O=ge(S.expirationTime<=I);if(I=r.unstable_now(),typeof O=="function"){S.callback=O,L(I),B=!0;break t}S===i(m)&&s(m),L(I)}else s(m);S=i(m)}if(S!==null)B=!0;else{var K=i(h);K!==null&&Z(F,K.startTime-I),B=!1}}break e}finally{S=null,v=ae,M=!1}B=void 0}}finally{B?ee():H=!1}}}var ee;if(typeof D=="function")ee=function(){D(G)};else if(typeof MessageChannel<"u"){var re=new MessageChannel,de=re.port2;re.port1.onmessage=G,ee=function(){de.postMessage(null)}}else ee=function(){x(G,0)};function Z(I,B){V=x(function(){I(r.unstable_now())},B)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(I){I.callback=null},r.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<I?Math.floor(1e3/I):5},r.unstable_getCurrentPriorityLevel=function(){return v},r.unstable_next=function(I){switch(v){case 1:case 2:case 3:var B=3;break;default:B=v}var ae=v;v=B;try{return I()}finally{v=ae}},r.unstable_requestPaint=function(){y=!0},r.unstable_runWithPriority=function(I,B){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var ae=v;v=I;try{return B()}finally{v=ae}},r.unstable_scheduleCallback=function(I,B,ae){var ge=r.unstable_now();switch(typeof ae=="object"&&ae!==null?(ae=ae.delay,ae=typeof ae=="number"&&0<ae?ge+ae:ge):ae=ge,I){case 1:var O=-1;break;case 2:O=250;break;case 5:O=1073741823;break;case 4:O=1e4;break;default:O=5e3}return O=ae+O,I={id:_++,callback:B,priorityLevel:I,startTime:ae,expirationTime:O,sortIndex:-1},ae>ge?(I.sortIndex=ae,e(h,I),i(m)===null&&I===i(h)&&(w?(N(V),V=-1):w=!0,Z(F,ae-ge))):(I.sortIndex=O,e(m,I),E||M||(E=!0,H||(H=!0,ee()))),I},r.unstable_shouldYield=fe,r.unstable_wrapCallback=function(I){var B=v;return function(){var ae=v;v=B;try{return I.apply(this,arguments)}finally{v=ae}}}}(hd)),hd}var z0;function JS(){return z0||(z0=1,dd.exports=QS()),dd.exports}var pd={exports:{}},wn={};/**
 * @license React
...
`)}const Aw={[h_]:"Linear",[p_]:"Reinhard",[m_]:"Cineon",[g_]:"ACESFilmic",[__]:"AgX",[x_]:"Neutral",[v_]:"Custom"};function Rw(r,e){const i=Aw[e];return i===void 0?(at("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Gc=new ce;function ww(){Mt.getLuminanceCoefficients(Gc);const r=Gc.x.toFixed(4),e=Gc.y.toFixed(4),i=Gc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+x);const D=N+y+f,L=N+x+p,F=Fv(l,l.VERTEX_SHADER,D),H=Fv(l,l.FRAGMENT_SHADER,L);l.attachShader(w,F),l.attachShader(w,H),i.index0AttributeName!==void 0?l.bindAttribLocation(w,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(w,0,"position"),l.linkProgram(w);function V(G){if(r.debug.checkShaderErrors){const ee=l.getProgramInfoLog(w)||"",re=l.getShaderInfoLog(F)||"",de=l.getShaderInfoLog(H)||"",Z=ee.trim(),I=re.trim(),B=de.trim();let ae=!0,ge=!0;if(l.getProgramParameter(w,l.LINK_STATUS)===!1)if(ae=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,w,F,H);else{const O=zv(l,F,"vertex"),K=zv(l,H,"fragment");At("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(w,l.VALIDATE_STATUS)+`
