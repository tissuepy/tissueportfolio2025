 ...
 */var O0;function YS(){if(O0)return Io;O0=1;var r=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(s,l,c){var f=null;if(c!==void 0&&(f=""+c),l.key!==void 0&&(f=""+l.key),"key"in l){c={};for(var p in l)p!=="key"&&(c[p]=l[p])}else c=l;return l=c.ref,{$$typeof:r,type:s,key:f,ref:l!==void 0?l:null,props:c}}return Io.Fragment=e,Io.jsx=i,Io.jsxs=i,Io}var P0;function ZS(){return P0||(P0=1,cd.exports=YS()),cd.exports}var g=ZS(),ud={exports:{}},ct={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var B0;function JS(){return B0||(B0=1,function(r){function e(I,z){var ce=I.length;I.push(z);e:for(;0<ce;){var ve=ce-1>>>1,O=I[ve];if(0<l(O,z))I[ve]=z,I[ce]=O,ce=ve;else break e}}function i(I){return I.length===0?null:I[0]}function s(I){if(I.length===0)return null;var z=I[0],ce=I.pop();if(ce!==z){I[0]=ce;e:for(var ve=0,O=I.length,Z=O>>>1;ve<Z;){var ue=2*(ve+1)-1,Se=I[ue],Ue=ue+1,qe=I[Ue];if(0>l(Se,ce))Ue<O&&0>l(qe,Se)?(I[ve]=qe,I[Ue]=ce,ve=Ue):(I[ve]=Se,I[ue]=ce,ve=ue);else if(Ue<O&&0>l(qe,ce))I[ve]=qe,I[Ue]=ce,ve=Ue;else break e}}return z}function l(I,z){var ce=I.sortIndex-z.sortIndex;return ce!==0?ce:I.id-z.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var f=Date,p=f.now();r.unstable_now=function(){return f.now()-p}}var m=[],h=[],_=1,S=null,v=3,M=!1,E=!1,C=!1,y=!1,x=typeof setTimeout=="function"?setTimeout:null,N=typeof clearTimeout=="function"?clearTimeout:null,D=typeof setImmediate<"u"?setImmediate:null;function L(I){for(var z=i(h);z!==null;){if(z.callback===null)s(h);else if(z.startTime<=I)s(h),z.sortIndex=z.expirationTime,e(m,z);else break;z=i(h)}}function F(I){if(C=!1,L(I),!E)if(i(m)!==null)E=!0,H||(H=!0,te());else{var z=i(h);z!==null&&J(F,z.startTime-I)}}var H=!1,V=-1,A=5,U=-1;function he(){return y?!0:!(r.unstable_now()-U<A)}function G(){if(y=!1,H){var I=r.unstable_now();U=I;var z=!0;try{e:{E=!1,C&&(C=!1,N(V),V=-1),M=!0;var ce=v;try{t:{for(L(I),S=i(m);S!==null&&!(S.expirationTime>I&&he());){var ve=S.callback;if(typeof ve=="function"){S.callback=null,v=S.priorityLevel;var O=ve(S.expirationTime<=I);if(I=r.unstable_now(),typeof O=="function"){S.callback=O,L(I),z=!0;break t}S===i(m)&&s(m),L(I)}else s(m);S=i(m)}if(S!==null)z=!0;else{var Z=i(h);Z!==null&&J(F,Z.startTime-I),z=!1}}break e}finally{S=null,v=ce,M=!1}z=void 0}}finally{z?te():H=!1}}}var te;if(typeof D=="function")te=function(){D(G)};else if(typeof MessageChannel<"u"){var ae=new MessageChannel,de=ae.port2;ae.port1.onmessage=G,te=function(){de.postMessage(null)}}else te=function(){x(G,0)};function J(I,z){V=x(function(){I(r.unstable_now())},z)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(I){I.callback=null},r.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<I?Math.floor(1e3/I):5},r.unstable_getCurrentPriorityLevel=function(){return v},r.unstable_next=function(I){switch(v){case 1:case 2:case 3:var z=3;break;default:z=v}var ce=v;v=z;try{return I()}finally{v=ce}},r.unstable_requestPaint=function(){y=!0},r.unstable_runWithPriority=function(I,z){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var ce=v;v=I;try{return z()}finally{v=ce}},r.unstable_scheduleCallback=function(I,z,ce){var ve=r.unstable_now();switch(typeof ce=="object"&&ce!==null?(ce=ce.delay,ce=typeof ce=="number"&&0<ce?ve+ce:ve):ce=ve,I){case 1:var O=-1;break;case 2:O=250;break;case 5:O=1073741823;break;case 4:O=1e4;break;default:O=5e3}return O=ce+O,I={id:_++,callback:z,priorityLevel:I,startTime:ce,expirationTime:O,sortIndex:-1},ce>ve?(I.sortIndex=ce,e(h,I),i(m)===null&&I===i(h)&&(C?(N(V),V=-1):C=!0,J(F,ce-ve))):(I.sortIndex=O,e(m,I),E||M||(E=!0,H||(H=!0,te()))),I},r.unstable_shouldYield=he,r.unstable_wrapCallback=function(I){var z=v;return function(){var ce=v;v=z;try{return I.apply(this,arguments)}finally{v=ce}}}}(hd)),hd}var z0;function $S(){return z0||(z0=1,dd.exports=JS()),dd.exports}var pd={exports:{}},wn={};/**
 * @license React
...
`)}const Rw={[p_]:"Linear",[m_]:"Reinhard",[g_]:"Cineon",[v_]:"ACESFilmic",[x_]:"AgX",[S_]:"Neutral",[__]:"Custom"};function ww(r,e){const i=Rw[e];return i===void 0?(at("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Gc=new le;function Cw(){Mt.getLuminanceCoefficients(Gc);const r=Gc.x.toFixed(4),e=Gc.y.toFixed(4),i=Gc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(Yo).join(`
`)),f=Xh(f),f=Gv(f,i),f=Vv(f,i),p=Xh(p),p=Gv(p,i),p=Vv(p,i),f=kv(f),p=kv(p),i.isRawShaderMaterial!==!0&&(N=`#version 300 es
