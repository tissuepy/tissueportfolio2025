 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var B0;function QS(){return B0||(B0=1,function(r){function e(I,B){var ae=I.length;I.push(B);e:for(;0<ae;){var ge=ae-1>>>1,O=I[ge];if(0<l(O,B))I[ge]=B,I[ae]=O,ae=ge;else break e}}function i(I){return I.length===0?null:I[0]}function s(I){if(I.length===0)return null;var B=I[0],ae=I.pop();if(ae!==B){I[0]=ae;e:for(var ge=0,O=I.length,K=O>>>1;ge<K;){var ue=2*(ge+1)-1,Se=I[ue],Ue=ue+1,qe=I[Ue];if(0>l(Se,ae))Ue<O&&0>l(qe,Se)?(I[ge]=qe,I[Ue]=ae,ge=Ue):(I[ge]=Se,I[ue]=ae,ge=ue);else if(Ue<O&&0>l(qe,ae))I[ge]=qe,I[Ue]=ae,ge=Ue;else break e}}return B}function l(I,B){var ae=I.sortIndex-B.sortIndex;return ae!==0?ae:I.id-B.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var f=Date,p=f.now();r.unstable_now=function(){return f.now()-p}}var m=[],h=[],_=1,S=null,v=3,M=!1,E=!1,w=!1,y=!1,x=typeof setTimeout=="function"?setTimeout:null,N=typeof clearTimeout=="function"?clearTimeout:null,D=typeof setImmediate<"u"?setImmediate:null;function L(I){for(var B=i(h);B!==null;){if(B.callback===null)s(h);else if(B.startTime<=I)s(h),B.sortIndex=B.expirationTime,e(m,B);else break;B=i(h)}}function F(I){if(w=!1,L(I),!E)if(i(m)!==null)E=!0,H||(H=!0,$());else{var B=i(h);B!==null&&Z(F,B.startTime-I)}}var H=!1,V=-1,A=5,U=-1;function fe(){return y?!0:!(r.unstable_now()-U<A)}function G(){if(y=!1,H){var I=r.unstable_now();U=I;var B=!0;try{e:{E=!1,w&&(w=!1,N(V),V=-1),M=!0;var ae=v;try{t:{for(L(I),S=i(m);S!==null&&!(S.expirationTime>I&&fe());){var ge=S.callback;if(typeof ge=="function"){S.callback=null,v=S.priorityLevel;var O=ge(S.expirationTime<=I);if(I=r.unstable_now(),typeof O=="function"){S.callback=O,L(I),B=!0;break t}S===i(m)&&s(m),L(I)}else s(m);S=i(m)}if(S!==null)B=!0;else{var K=i(h);K!==null&&Z(F,K.startTime-I),B=!1}}break e}finally{S=null,v=ae,M=!1}B=void 0}}finally{B?$():H=!1}}}var $;if(typeof D=="function")$=function(){D(G)};else if(typeof MessageChannel<"u"){var re=new MessageChannel,de=re.port2;re.port1.onmessage=G,$=function(){de.postMessage(null)}}else $=function(){x(G,0)};function Z(I,B){V=x(function(){I(r.unstable_now())},B)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(I){I.callback=null},r.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<I?Math.floor(1e3/I):5},r.unstable_getCurrentPriorityLevel=function(){return v},r.unstable_next=function(I){switch(v){case 1:case 2:case 3:var B=3;break;default:B=v}var ae=v;v=B;try{return I()}finally{v=ae}},r.unstable_requestPaint=function(){y=!0},r.unstable_runWithPriority=function(I,B){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var ae=v;v=I;try{return B()}finally{v=ae}},r.unstable_scheduleCallback=function(I,B,ae){var ge=r.unstable_now();switch(typeof ae=="object"&&ae!==null?(ae=ae.delay,ae=typeof ae=="number"&&0<ae?ge+ae:ge):ae=ge,I){case 1:var O=-1;break;case 2:O=250;break;case 5:O=1073741823;break;case 4:O=1e4;break;default:O=5e3}return O=ae+O,I={id:_++,callback:B,priorityLevel:I,startTime:ae,expirationTime:O,sortIndex:-1},ae>ge?(I.sortIndex=ae,e(h,I),i(m)===null&&I===i(h)&&(w?(N(V),V=-1):w=!0,Z(F,ae-ge))):(I.sortIndex=O,e(m,I),E||M||(E=!0,H||(H=!0,$()))),I},r.unstable_shouldYield=fe,r.unstable_wrapCallback=function(I){var B=v;return function(){var ae=v;v=B;try{return I.apply(this,arguments)}finally{v=ae}}}}(hd)),hd}var z0;function JS(){return z0||(z0=1,dd.exports=QS()),dd.exports}var pd={exports:{}},wn={};/**
 * @license React
...
`)+`
`+x);const D=N+y+f,L=N+x+p,F=Fv(l,l.VERTEX_SHADER,D),H=Fv(l,l.FRAGMENT_SHADER,L);l.attachShader(w,F),l.attachShader(w,H),i.index0AttributeName!==void 0?l.bindAttribLocation(w,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(w,0,"position"),l.linkProgram(w);function V(G){if(r.debug.checkShaderErrors){const $=l.getProgramInfoLog(w)||"",re=l.getShaderInfoLog(F)||"",de=l.getShaderInfoLog(H)||"",Z=$.trim(),I=re.trim(),B=de.trim();let ae=!0,ge=!0;if(l.getProgramParameter(w,l.LINK_STATUS)===!1)if(ae=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,w,F,H);else{const O=zv(l,F,"vertex"),K=zv(l,H,"fragment");At("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(w,l.VALIDATE_STATUS)+`
