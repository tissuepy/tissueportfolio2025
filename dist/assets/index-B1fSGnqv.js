 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var H0;function ty(){return H0||(H0=1,function(r){function e(I,z){var ce=I.length;I.push(z);e:for(;0<ce;){var ve=ce-1>>>1,O=I[ve];if(0<l(O,z))I[ve]=z,I[ce]=O,ce=ve;else break e}}function i(I){return I.length===0?null:I[0]}function s(I){if(I.length===0)return null;var z=I[0],ce=I.pop();if(ce!==z){I[0]=ce;e:for(var ve=0,O=I.length,Z=O>>>1;ve<Z;){var ue=2*(ve+1)-1,Se=I[ue],Ue=ue+1,qe=I[Ue];if(0>l(Se,ce))Ue<O&&0>l(qe,Se)?(I[ve]=qe,I[Ue]=ce,ve=Ue):(I[ve]=Se,I[ue]=ce,ve=ue);else if(Ue<O&&0>l(qe,ce))I[ve]=qe,I[Ue]=ce,ve=Ue;else break e}}return z}function l(I,z){var ce=I.sortIndex-z.sortIndex;return ce!==0?ce:I.id-z.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var f=Date,m=f.now();r.unstable_now=function(){return f.now()-m}}var g=[],h=[],_=1,S=null,v=3,M=!1,b=!1,C=!1,y=!1,x=typeof setTimeout=="function"?setTimeout:null,N=typeof clearTimeout=="function"?clearTimeout:null,D=typeof setImmediate<"u"?setImmediate:null;function L(I){for(var z=i(h);z!==null;){if(z.callback===null)s(h);else if(z.startTime<=I)s(h),z.sortIndex=z.expirationTime,e(g,z);else break;z=i(h)}}function F(I){if(C=!1,L(I),!b)if(i(g)!==null)b=!0,H||(H=!0,te());else{var z=i(h);z!==null&&J(F,z.startTime-I)}}var H=!1,V=-1,A=5,U=-1;function he(){return y?!0:!(r.unstable_now()-U<A)}function G(){if(y=!1,H){var I=r.unstable_now();U=I;var z=!0;try{e:{b=!1,C&&(C=!1,N(V),V=-1),M=!0;var ce=v;try{t:{for(L(I),S=i(g);S!==null&&!(S.expirationTime>I&&he());){var ve=S.callback;if(typeof ve=="function"){S.callback=null,v=S.priorityLevel;var O=ve(S.expirationTime<=I);if(I=r.unstable_now(),typeof O=="function"){S.callback=O,L(I),z=!0;break t}S===i(g)&&s(g),L(I)}else s(g);S=i(g)}if(S!==null)z=!0;else{var Z=i(h);Z!==null&&J(F,Z.startTime-I),z=!1}}break e}finally{S=null,v=ce,M=!1}z=void 0}}finally{z?te():H=!1}}}var te;if(typeof D=="function")te=function(){D(G)};else if(typeof MessageChannel<"u"){var se=new MessageChannel,de=se.port2;se.port1.onmessage=G,te=function(){de.postMessage(null)}}else te=function(){x(G,0)};function J(I,z){V=x(function(){I(r.unstable_now())},z)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(I){I.callback=null},r.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<I?Math.floor(1e3/I):5},r.unstable_getCurrentPriorityLevel=function(){return v},r.unstable_next=function(I){switch(v){case 1:case 2:case 3:var z=3;break;default:z=v}var ce=v;v=z;try{return I()}finally{v=ce}},r.unstable_requestPaint=function(){y=!0},r.unstable_runWithPriority=function(I,z){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var ce=v;v=I;try{return z()}finally{v=ce}},r.unstable_scheduleCallback=function(I,z,ce){var ve=r.unstable_now();switch(typeof ce=="object"&&ce!==null?(ce=ce.delay,ce=typeof ce=="number"&&0<ce?ve+ce:ve):ce=ve,I){case 1:var O=-1;break;case 2:O=250;break;case 5:O=1073741823;break;case 4:O=1e4;break;default:O=5e3}return O=ce+O,I={id:_++,callback:z,priorityLevel:I,startTime:ce,expirationTime:O,sortIndex:-1},ce>ve?(I.sortIndex=ce,e(h,I),i(g)===null&&I===i(h)&&(C?(N(V),V=-1):C=!0,J(F,ce-ve))):(I.sortIndex=O,e(g,I),b||M||(b=!0,H||(H=!0,te()))),I},r.unstable_shouldYield=he,r.unstable_wrapCallback=function(I){var z=v;return function(){var ce=v;v=z;try{return I.apply(this,arguments)}finally{v=ce}}}}(md)),md}var G0;function ny(){return G0||(G0=1,pd.exports=ty()),pd.exports}var gd={exports:{}},Rn={};/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:va,depthTest:!1,depthWrite:!1})}function zw(r,e,i){const s=new Float32Array(Us),l=new le(0,1,0);return new bi({name:"SphericalGaussianBlur",defines:{n:Us,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:ou(),fragmentShader:`
	...
	`}class X_ extends Bi{constructor(e=1,i={}){super(e,e,i),this.isWebGLCubeRenderTarget=!0;const s={width:e,height:e,depth:1},l=[s,s,s,s,s,s];this.texture=new H_(l),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const s={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},l=new sl(5,5,5),c=new bi({name:"CubemapFromEquirect",uniforms:Br(s.uniforms),vertexShader:s.vertexShader,fragmentShader:s.fragmentShader,side:kn,blending:va});c.uniforms.tEquirect.value=i;const f=new Vi(l,c),m=i.minFilter;return i.minFilter===Ls&&(i.minFilter=Dn),new XT(1,10,this).update(e,f),i.minFilter=m,f.geometry.dispose(),f.material.dispose(),this}clear(e,i=!0,s=!0,l=!0){const c=e.getRenderTarget();for(let f=0;f<6;f++)e.setRenderTarget(this,f),e.clear(i,s,l);e.setRenderTarget(c)}}function Hw(r){let e=new WeakMap,i=new WeakMap,s=null;function l(v,M=!1){return v==null?null:M?f(v):c(v)}function c(v){if(v&&v.isTexture){const M=v.mapping;if(M===yd||M===Md)if(e.has(v)){const b=e.get(v).texture;return m(b,v.mapping)}else{const b=v.image;if(b&&b.height>0){const C=new X_(b.height);return C.fromEquirectangularTexture(r,v),e.set(v,C),v.addEventListener("dispose",h),m(C.texture,v.mapping)}else return null}}return v}function f(v){if(v&&v.isTexture){const M=v.mapping,b=M===yd||M===Md,C=M===Ps||M===Pr;if(b||C){let y=i.get(v);const x=y!==void 0?y.texture.pmremVersion:0;if(v.isRenderTargetTexture&&v.pmremVersion!==x)return s===null&&(s=new Dv(r)),y=b?s.fromEquirectangular(v,y):s.fromCubemap(v,y),y.texture.pmremVersion=v.pmremVersion,i.set(v,y),y.texture;if(y!==void 0)return y.texture;{const N=v.image;return b&&N&&N.height>0||C&&N&&g(N)?(s===null&&(s=new Dv(r)),y=b?s.fromEquirectangular(v):s.fromCubemap(v),y.texture.pmremVersion=v.pmremVersion,i.set(v,y),v.addEventListener("dispose",_),y.texture):null}}}return v}function m(v,M){return M===yd?v.mapping=Ps:M===Md&&(v.mapping=Pr),v}function g(v){let M=0;const b=6;for(let C=0;C<b;C++)v[C]!==void 0&&M++;return M===b}function h(v){const M=v.target;M.removeEventListener("dispose",h);const b=e.get(M);b!==void 0&&(e.delete(M),b.dispose())}function _(v){const M=v.target;M.removeEventListener("dispose",_);const b=i.get(M);b!==void 0&&(i.delete(M),b.dispose())}function S(){e=new WeakMap,i=new WeakMap,s!==null&&(s.dispose(),s=null)}return{get:l,dispose:S}}function Gw(r){const e={};function i(s){if(e[s]!==void 0)return e[s];const l=r.getExtension(s);return e[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&nu("WebGLRenderer: "+s+" extension not supported."),l}}}function Vw(r,e,i,s){const l={},c=new WeakMap;function f(S){const v=S.target;v.index!==null&&e.remove(v.index);for(const b in v.attributes)e.remove(v.attributes[b]);v.removeEventListener("dispose",f),delete l[v.id];const M=c.get(v);M&&(e.remove(M),c.delete(v)),s.releaseStatesOfGeometry(v),v.isInstancedBufferGeometry===!0&&delete v._maxInstanceCount,i.memory.geometries--}function m(S,v){return l[v.id]===!0||(v.addEventListener("dispose",f),l[v.id]=!0,i.memory.geometries++),v}function g(S){const v=S.attributes;for(const M in v)e.update(v[M],r.ARRAY_BUFFER)}function h(S){const v=[],M=S.index,b=S.attributes.position;let C=0;if(b===void 0)return;if(M!==null){const N=M.array;C=M.version;for(let D=0,L=N.length;D<L;D+=3){const F=N[D+0],H=N[D+1],V=N[D+2];v.push(F,H,H,V,V,F)}}else{const N=b.array;C=b.version;for(let D=0,L=N.length/3-1;D<L;D+=3){const F=D+0,H=D+1,V=D+2;v.push(F,H,H,V,V,F)}}const y=new(b.count>=65535?F_:I_)(v,1);y.version=C;const x=c.get(S);x&&e.remove(x),c.set(S,y)}function _(S){const v=c.get(S);if(v){const M=S.index;M!==null&&v.version<M.version&&h(S)}else h(S);return c.get(S)}return{get:m,update:g,getWireframeAttribute:_}}function kw(r,e,i){let s;function l(v){s=v}let c,f;function m(v){c=v.type,f=v.bytesPerElement}function g(v,M){r.drawElements(s,M,c,v*f),i.update(M,s,1)}function h(v,M,b){b!==0&&(r.drawElementsInstanced(s,M,c,v*f,b),i.update(M,s,b))}function _(v,M,b){if(b===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,M,0,c,v,0,b);let y=0;for(let x=0;x<b;x++)y+=M[x];i.update(y,s,1)}function S(v,M,b,C){if(b===0)return;const y=e.get("WEBGL_multi_draw");if(y===null)for(let x=0;x<v.length;x++)h(v[x]/f,M[x],C[x]);else{y.multiDrawElementsInstancedWEBGL(s,M,0,c,v,0,C,0,b);let x=0;for(let N=0;N<b;N++)x+=M[N]*C[N];i.update(x,s,1)}}this.setMode=l,this.setIndex=m,this.render=g,this.renderInstances=h,this.renderMultiDraw=_,this.renderMultiDrawInstances=S}function jw(r){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,f,m){switch(i.calls++,f){case r.TRIANGLES:i.triangles+=m*(c/3);break;case r.LINES:i.lines+=m*(c/2);break;case r.LINE_STRIP:i.lines+=m*(c-1);break;case r.LINE_LOOP:i.lines+=m*c;break;case r.POINTS:i.points+=m*c;break;default:At("WebGLInfo: Unknown draw mode:",f);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:s}}function Xw(r,e,i){const s=new WeakMap,l=new on;function c(f,m,g){const h=f.morphTargetInfluences,_=m.morphAttributes.position||m.morphAttributes.normal||m.morphAttributes.color,S=_!==void 0?_.length:0;let v=s.get(m);if(v===void 0||v.count!==S){let he=function(){A.dispose(),s.delete(m),m.removeEventListener("dispose",he)};var M=he;v!==void 0&&v.texture.dispose();const b=m.morphAttributes.position!==void 0,C=m.morphAttributes.normal!==void 0,y=m.morphAttributes.color!==void 0,x=m.morphAttributes.position||[],N=m.morphAttributes.normal||[],D=m.morphAttributes.color||[];let L=0;b===!0&&(L=1),C===!0&&(L=2),y===!0&&(L=3);let F=m.attributes.position.count*L,H=1;F>e.maxTextureSize&&(H=Math.ceil(F/e.maxTextureSize),F=e.maxTextureSize);const V=new Float32Array(F*H*4*S),A=new L_(V,F,H,S);A.type=Pi,A.needsUpdate=!0;const U=L*4;for(let G=0;G<S;G++){const te=x[G],se=N[G],de=D[G],J=F*H*4*G;for(let I=0;I<te.count;I++){const z=I*U;b===!0&&(l.fromBufferAttribute(te,I),V[J+z+0]=l.x,V[J+z+1]=l.y,V[J+z+2]=l.z,V[J+z+3]=0),C===!0&&(l.fromBufferAttribute(se,I),V[J+z+4]=l.x,V[J+z+5]=l.y,V[J+z+6]=l.z,V[J+z+7]=0),y===!0&&(l.fromBufferAttribute(de,I),V[J+z+8]=l.x,V[J+z+9]=l.y,V[J+z+10]=l.z,V[J+z+11]=de.itemSize===4?l.w:1)}}v={count:S,texture:A,size:new Lt(F,H)},s.set(m,v),m.addEventListener("dispose",he)}if(f.isInstancedMesh===!0&&f.morphTexture!==null)g.getUniforms().setValue(r,"morphTexture",f.morphTexture,i);else{let b=0;for(let y=0;y<h.length;y++)b+=h[y];const C=m.morphTargetsRelative?1:1-b;g.getUniforms().setValue(r,"morphTargetBaseInfluence",C),g.getUniforms().setValue(r,"morphTargetInfluences",h)}g.getUniforms().setValue(r,"morphTargetsTexture",v.texture,i),g.getUniforms().setValue(r,"morphTargetsTextureSize",v.size)}return{update:c}}function Ww(r,e,i,s,l){let c=new WeakMap;function f(h){const _=l.render.frame,S=h.geometry,v=e.get(h,S);if(c.get(v)!==_&&(e.update(v),c.set(v,_)),h.isInstancedMesh&&(h.hasEventListener("dispose",g)===!1&&h.addEventListener("dispose",g),c.get(h)!==_&&(i.update(h.instanceMatrix,r.ARRAY_BUFFER),h.instanceColor!==null&&i.update(h.instanceColor,r.ARRAY_BUFFER),c.set(h,_))),h.isSkinnedMesh){const M=h.skeleton;c.get(M)!==_&&(M.update(),c.set(M,_))}return v}function m(){c=new WeakMap}function g(h){const _=h.target;_.removeEventListener("dispose",g),s.releaseStatesOfObject(_),i.remove(_.instanceMatrix),_.instanceColor!==null&&i.remove(_.instanceColor)}return{update:f,dispose:m}}const qw={[v_]:"LINEAR_TONE_MAPPING",[__]:"REINHARD_TONE_MAPPING",[x_]:"CINEON_TONE_MAPPING",[S_]:"ACES_FILMIC_TONE_MAPPING",[M_]:"AGX_TONE_MAPPING",[b_]:"NEUTRAL_TONE_MAPPING",[y_]:"CUSTOM_TONE_MAPPING"};function Yw(r,e,i,s,l){const c=new Bi(e,i,{type:r,depthBuffer:s,stencilBuffer:l}),f=new Bi(e,i,{type:ya,depthBuffer:!1,stencilBuffer:!1}),m=new Ta;m.setAttribute("position",new xa([-1,3,0,-1,-1,0,3,-1,0],3)),m.setAttribute("uv",new xa([0,2,0,0,2,0],2));const g=new VT({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),h=new Vi(m,g),_=new fp(-1,1,1,-1,0,1);let S=null,v=null,M=!1,b,C=null,y=[],x=!1;this.setSize=function(N,D){c.setSize(N,D),f.setSize(N,D);for(let L=0;L<y.length;L++){const F=y[L];F.setSize&&F.setSize(N,D)}},this.setEffects=function(N){y=N,x=y.length>0&&y[0].isRenderPass===!0;const D=c.width,L=c.height;for(let F=0;F<y.length;F++){const H=y[F];H.setSize&&H.setSize(D,L)}},this.begin=function(N,D){if(M||N.toneMapping===Fi&&y.length===0)return!1;if(C=D,D!==null){const L=D.width,F=D.height;(c.width!==L||c.height!==F)&&this.setSize(L,F)}return x===!1&&N.setRenderTarget(c),b=N.toneMapping,N.toneMapping=Fi,!0},this.hasRenderPass=function(){return x},this.end=function(N,D){N.toneMapping=b,M=!0;let L=c,F=f;for(let H=0;H<y.length;H++){const V=y[H];if(V.enabled!==!1&&(V.render(N,F,L,D),V.needsSwap!==!1)){const A=L;L=F,F=A}}if(S!==N.outputColorSpace||v!==N.toneMapping){S=N.outputColorSpace,v=N.toneMapping,g.defines={},Mt.getTransfer(S)===Ft&&(g.defines.SRGB_TRANSFER="");const H=qw[v];H&&(g.defines[H]=""),g.needsUpdate=!0}g.uniforms.tDiffuse.value=L.texture,N.setRenderTarget(C),N.render(h,_),C=null,M=!1},this.isCompositing=function(){return M},this.dispose=function(){c.dispose(),f.dispose(),m.dispose(),g.dispose()}}const W_=new On,Wh=new $o(1,1),q_=new L_,Y_=new _T,Z_=new H_,Pv=[],Iv=[],Fv=new Float32Array(16),Bv=new Float32Array(9),zv=new Float32Array(4);function kr(r,e,i){const s=r[0];if(s<=0||s>0)return r;const l=e*i;let c=Pv[l];if(c===void 0&&(c=new Float32Array(l),Pv[l]=c),e!==0){s.toArray(c,0);for(let f=1,m=0;f!==e;++f)m+=i,r[f].toArray(c,m)}return c}function mn(r,e){if(r.length!==e.length)return!1;for(let i=0,s=r.length;i<s;i++)if(r[i]!==e[i])return!1;return!0}function gn(r,e){for(let i=0,s=e.length;i<s;i++)r[i]=e[i]}function lu(r,e){let i=Iv[e];i===void 0&&(i=new Int32Array(e),Iv[e]=i);for(let s=0;s!==e;++s)i[s]=r.allocateTextureUnit();return i}function Zw(r,e){const i=this.cache;i[0]!==e&&(r.uniform1f(this.addr,e),i[0]=e)}function Kw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2f(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(mn(i,e))return;r.uniform2fv(this.addr,e),gn(i,e)}}function Qw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3f(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else if(e.r!==void 0)(i[0]!==e.r||i[1]!==e.g||i[2]!==e.b)&&(r.uniform3f(this.addr,e.r,e.g,e.b),i[0]=e.r,i[1]=e.g,i[2]=e.b);else{if(mn(i,e))return;r.uniform3fv(this.addr,e),gn(i,e)}}function Jw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(mn(i,e))return;r.uniform4fv(this.addr,e),gn(i,e)}}function $w(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(mn(i,e))return;r.uniformMatrix2fv(this.addr,!1,e),gn(i,e)}else{if(mn(i,s))return;zv.set(s),r.uniformMatrix2fv(this.addr,!1,zv),gn(i,s)}}function eR(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(mn(i,e))return;r.uniformMatrix3fv(this.addr,!1,e),gn(i,e)}else{if(mn(i,s))return;Bv.set(s),r.uniformMatrix3fv(this.addr,!1,Bv),gn(i,s)}}function tR(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(mn(i,e))return;r.uniformMatrix4fv(this.addr,!1,e),gn(i,e)}else{if(mn(i,s))return;Fv.set(s),r.uniformMatrix4fv(this.addr,!1,Fv),gn(i,s)}}function nR(r,e){const i=this.cache;i[0]!==e&&(r.uniform1i(this.addr,e),i[0]=e)}function iR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2i(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(mn(i,e))return;r.uniform2iv(this.addr,e),gn(i,e)}}function aR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3i(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(mn(i,e))return;r.uniform3iv(this.addr,e),gn(i,e)}}function sR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(mn(i,e))return;r.uniform4iv(this.addr,e),gn(i,e)}}function rR(r,e){const i=this.cache;i[0]!==e&&(r.uniform1ui(this.addr,e),i[0]=e)}function oR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2ui(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(mn(i,e))return;r.uniform2uiv(this.addr,e),gn(i,e)}}function lR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3ui(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(mn(i,e))return;r.uniform3uiv(this.addr,e),gn(i,e)}}function cR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(mn(i,e))return;r.uniform4uiv(this.addr,e),gn(i,e)}}function uR(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l);let c;this.type===r.SAMPLER_2D_SHADOW?(Wh.compareFunction=i.isReversedDepthBuffer()?lp:op,c=Wh):c=W_,i.setTexture2D(e||c,l)}function fR(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture3D(e||Y_,l)}function dR(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTextureCube(e||Z_,l)}function hR(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture2DArray(e||q_,l)}function pR(r){switch(r){case 5126:return Zw;case 35664:return Kw;case 35665:return Qw;case 35666:return Jw;case 35674:return $w;case 35675:return eR;case 35676:return tR;case 5124:case 35670:return nR;case 35667:case 35671:return iR;case 35668:case 35672:return aR;case 35669:case 35673:return sR;case 5125:return rR;case 36294:return oR;case 36295:return lR;case 36296:return cR;case 35678:case 36198:case 36298:case 36306:case 35682:return uR;case 35679:case 36299:case 36307:return fR;case 35680:case 36300:case 36308:case 36293:return dR;case 36289:case 36303:case 36311:case 36292:return hR}}function mR(r,e){r.uniform1fv(this.addr,e)}function gR(r,e){const i=kr(e,this.size,2);r.uniform2fv(this.addr,i)}function vR(r,e){const i=kr(e,this.size,3);r.uniform3fv(this.addr,i)}function _R(r,e){const i=kr(e,this.size,4);r.uniform4fv(this.addr,i)}function xR(r,e){const i=kr(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,i)}function SR(r,e){const i=kr(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,i)}function yR(r,e){const i=kr(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,i)}function MR(r,e){r.uniform1iv(this.addr,e)}function bR(r,e){r.uniform2iv(this.addr,e)}function ER(r,e){r.uniform3iv(this.addr,e)}function TR(r,e){r.uniform4iv(this.addr,e)}function AR(r,e){r.uniform1uiv(this.addr,e)}function wR(r,e){r.uniform2uiv(this.addr,e)}function RR(r,e){r.uniform3uiv(this.addr,e)}function CR(r,e){r.uniform4uiv(this.addr,e)}function NR(r,e,i){const s=this.cache,l=e.length,c=lu(i,l);mn(s,c)||(r.uniform1iv(this.addr,c),gn(s,c));let f;this.type===r.SAMPLER_2D_SHADOW?f=Wh:f=W_;for(let m=0;m!==l;++m)i.setTexture2D(e[m]||f,c[m])}function DR(r,e,i){const s=this.cache,l=e.length,c=lu(i,l);mn(s,c)||(r.uniform1iv(this.addr,c),gn(s,c));for(let f=0;f!==l;++f)i.setTexture3D(e[f]||Y_,c[f])}function UR(r,e,i){const s=this.cache,l=e.length,c=lu(i,l);mn(s,c)||(r.uniform1iv(this.addr,c),gn(s,c));for(let f=0;f!==l;++f)i.setTextureCube(e[f]||Z_,c[f])}function LR(r,e,i){const s=this.cache,l=e.length,c=lu(i,l);mn(s,c)||(r.uniform1iv(this.addr,c),gn(s,c));for(let f=0;f!==l;++f)i.setTexture2DArray(e[f]||q_,c[f])}function OR(r){switch(r){case 5126:return mR;case 35664:return gR;case 35665:return vR;case 35666:return _R;case 35674:return xR;case 35675:return SR;case 35676:return yR;case 5124:case 35670:return MR;case 35667:case 35671:return bR;case 35668:case 35672:return ER;case 35669:case 35673:return TR;case 5125:return AR;case 36294:return wR;case 36295:return RR;case 36296:return CR;case 35678:case 36198:case 36298:case 36306:case 35682:return NR;case 35679:case 36299:case 36307:return DR;case 35680:case 36300:case 36308:case 36293:return UR;case 36289:case 36303:case 36311:case 36292:return LR}}class PR{constructor(e,i,s){this.id=e,this.addr=s,this.cache=[],this.type=i.type,this.setValue=pR(i.type)}}class IR{constructor(e,i,s){this.id=e,this.addr=s,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=OR(i.type)}}class FR{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,i,s){const l=this.seq;for(let c=0,f=l.length;c!==f;++c){const m=l[c];m.setValue(e,i[m.id],s)}}}const Jd=/(\w+)(\])?(\[|\.)?/g;function Hv(r,e){r.seq.push(e),r.map[e.id]=e}function BR(r,e,i){const s=r.name,l=s.length;for(Jd.lastIndex=0;;){const c=Jd.exec(s),f=Jd.lastIndex;let m=c[1];const g=c[2]==="]",h=c[3];if(g&&(m=m|0),h===void 0||h==="["&&f+2===l){Hv(i,h===void 0?new PR(m,r,e):new IR(m,r,e));break}else{let S=i.map[m];S===void 0&&(S=new FR(m),Hv(i,S)),i=S}}}class Qc{constructor(e,i){this.seq=[],this.map={};const s=e.getProgramParameter(i,e.ACTIVE_UNIFORMS);for(let f=0;f<s;++f){const m=e.getActiveUniform(i,f),g=e.getUniformLocation(i,m.name);BR(m,g,this)}const l=[],c=[];for(const f of this.seq)f.type===e.SAMPLER_2D_SHADOW||f.type===e.SAMPLER_CUBE_SHADOW||f.type===e.SAMPLER_2D_ARRAY_SHADOW?l.push(f):c.push(f);l.length>0&&(this.seq=l.concat(c))}setValue(e,i,s,l){const c=this.map[i];c!==void 0&&c.setValue(e,s,l)}setOptional(e,i,s){const l=i[s];l!==void 0&&this.setValue(e,s,l)}static upload(e,i,s,l){for(let c=0,f=i.length;c!==f;++c){const m=i[c],g=s[m.id];g.needsUpdate!==!1&&m.setValue(e,g.value,l)}}static seqWithValue(e,i){const s=[];for(let l=0,c=e.length;l!==c;++l){const f=e[l];f.id in i&&s.push(f)}return s}}function Gv(r,e,i){const s=r.createShader(e);return r.shaderSource(s,i),r.compileShader(s),s}const zR=37297;let HR=0;function GR(r,e){const i=r.split(`
`),s=[],l=Math.max(e-6,0),c=Math.min(e+6,i.length);for(let f=l;f<c;f++){const m=f+1;s.push(`${m===e?">":" "} ${m}: ${i[f]}`)}return s.join(`
`)}const Vv=new ut;function VR(r){Mt._getMatrix(Vv,Mt.workingColorSpace,r);const e=`mat3( ${Vv.elements.map(i=>i.toFixed(4))} )`;switch(Mt.getTransfer(r)){case $c:return[e,"LinearTransferOETF"];case Ft:return[e,"sRGBTransferOETF"];default:return at("WebGLProgram: Unsupported color space: ",r),[e,"LinearTransferOETF"]}}function kv(r,e,i){const s=r.getShaderParameter(e,r.COMPILE_STATUS),c=(r.getShaderInfoLog(e)||"").trim();if(s&&c==="")return"";const f=/ERROR: 0:(\d+)/.exec(c);if(f){const m=parseInt(f[1]);return i.toUpperCase()+`

`+c+`

`+GR(r.getShaderSource(e),m)}else return c}function kR(r,e){const i=VR(e);return[`vec4 ${r}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}const jR={[v_]:"Linear",[__]:"Reinhard",[x_]:"Cineon",[S_]:"ACESFilmic",[M_]:"AgX",[b_]:"Neutral",[y_]:"Custom"};function XR(r,e){const i=jR[e];return i===void 0?(at("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Vc=new le;function WR(){Mt.getLuminanceCoefficients(Vc);const r=Vc.x.toFixed(4),e=Vc.y.toFixed(4),i=Vc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function qR(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Zo).join(`
`)}function YR(r){const e=[];for(const i in r){const s=r[i];s!==!1&&e.push("#define "+i+" "+s)}return e.join(`
`)}function ZR(r,e){const i={},s=r.getProgramParameter(e,r.ACTIVE_ATTRIBUTES);for(let l=0;l<s;l++){const c=r.getActiveAttrib(e,l),f=c.name;let m=1;c.type===r.FLOAT_MAT2&&(m=2),c.type===r.FLOAT_MAT3&&(m=3),c.type===r.FLOAT_MAT4&&(m=4),i[f]={type:c.type,location:r.getAttribLocation(e,f),locationSize:m}}return i}function Zo(r){return r!==""}function jv(r,e){const i=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Xv(r,e){return r.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const KR=/^[ \t]*#include +<([\w\d./]+)>/gm;function qh(r){return r.replace(KR,JR)}const QR=new Map;function JR(r,e){let i=ft[e];if(i===void 0){const s=QR.get(e);if(s!==void 0)i=ft[s],at('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,s);else throw new Error("Can not resolve #include <"+e+">")}return qh(i)}const $R=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Wv(r){return r.replace($R,eC)}function eC(r,e,i,s){let l="";for(let c=parseInt(e);c<parseInt(i);c++)l+=s.replace(/\[\s*i\s*\]/g,"[ "+c+" ]").replace(/UNROLLED_LOOP_INDEX/g,c);return l}function qv(r){let e=`precision ${r.precision} float;
...
#define LOW_PRECISION`),e}const tC={[Wc]:"SHADOWMAP_TYPE_PCF",[Yo]:"SHADOWMAP_TYPE_VSM"};function nC(r){return tC[r.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const iC={[Ps]:"ENVMAP_TYPE_CUBE",[Pr]:"ENVMAP_TYPE_CUBE",[su]:"ENVMAP_TYPE_CUBE_UV"};function aC(r){return r.envMap===!1?"ENVMAP_TYPE_CUBE":iC[r.envMapMode]||"ENVMAP_TYPE_CUBE"}const sC={[Pr]:"ENVMAP_MODE_REFRACTION"};function rC(r){return r.envMap===!1?"ENVMAP_MODE_REFLECTION":sC[r.envMapMode]||"ENVMAP_MODE_REFLECTION"}const oC={[g_]:"ENVMAP_BLENDING_MULTIPLY",[KE]:"ENVMAP_BLENDING_MIX",[QE]:"ENVMAP_BLENDING_ADD"};function lC(r){return r.envMap===!1?"ENVMAP_BLENDING_NONE":oC[r.combine]||"ENVMAP_BLENDING_NONE"}function cC(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,s=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),7*16)),texelHeight:s,maxMip:i}}function uC(r,e,i,s){const l=r.getContext(),c=i.defines;let f=i.vertexShader,m=i.fragmentShader;const g=nC(i),h=aC(i),_=rC(i),S=lC(i),v=cC(i),M=qR(i),b=YR(c),C=l.createProgram();let y,x,N=i.glslVersion?"#version "+i.glslVersion+`
