...
#endif`,y1="gl_FragColor = linearToOutputTexel( gl_FragColor );",M1=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:va,depthTest:!1,depthWrite:!1})}function Ow(r,e,i){const s=new Float32Array(Us),l=new oe(0,1,0);return new bi({name:"SphericalGaussianBlur",defines:{n:Us,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:ou(),fragmentShader:`
	...
	`}class X_ extends Bi{constructor(e=1,i={}){super(e,e,i),this.isWebGLCubeRenderTarget=!0;const s={width:e,height:e,depth:1},l=[s,s,s,s,s,s];this.texture=new H_(l),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const s={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),h=new Vi(m,g),_=new fp(-1,1,1,-1,0,1);let S=null,v=null,M=!1,b,C=null,y=[],x=!1;this.setSize=function(N,D){c.setSize(N,D),f.setSize(N,D);for(let L=0;L<y.length;L++){const F=y[L];F.setSize&&F.setSize(N,D)}},this.setEffects=function(N){y=N,x=y.length>0&&y[0].isRenderPass===!0;const D=c.width,L=c.height;for(let F=0;F<y.length;F++){const H=y[F];H.setSize&&H.setSize(D,L)}},this.begin=function(N,D){if(M||N.toneMapping===Fi&&y.length===0)return!1;if(C=D,D!==null){const L=D.width,F=D.height;(c.width!==L||c.height!==F)&&this.setSize(L,F)}return x===!1&&N.setRenderTarget(c),b=N.toneMapping,N.toneMapping=Fi,!0},this.hasRenderPass=function(){return x},this.end=function(N,D){N.toneMapping=b,M=!0;let L=c,F=f;for(let H=0;H<y.length;H++){const V=y[H];if(V.enabled!==!1&&(V.render(N,F,L,D),V.needsSwap!==!1)){const A=L;L=F,F=A}}if(S!==N.outputColorSpace||v!==N.toneMapping){S=N.outputColorSpace,v=N.toneMapping,g.defines={},Mt.getTransfer(S)===Ft&&(g.defines.SRGB_TRANSFER="");const H=Vw[v];H&&(g.defines[H]=""),g.needsUpdate=!0}g.uniforms.tDiffuse.value=L.texture,N.setRenderTarget(C),N.render(h,_),C=null,M=!1},this.isCompositing=function(){return M},this.dispose=function(){c.dispose(),f.dispose(),m.dispose(),g.dispose()}}const W_=new On,Wh=new $o(1,1),q_=new L_,Y_=new hT,Z_=new H_,Pv=[],Iv=[],Fv=new Float32Array(16),Bv=new Float32Array(9),zv=new Float32Array(4);function kr(r,e,i){const s=r[0];if(s<=0||s>0)return r;const l=e*i;let c=Pv[l];if(c===void 0&&(c=new Float32Array(l),Pv[l]=c),e!==0){s.toArray(c,0);for(let f=1,m=0;f!==e;++f)m+=i,r[f].toArray(c,m)}return c}function mn(r,e){if(r.length!==e.length)return!1;for(let i=0,s=r.length;i<s;i++)if(r[i]!==e[i])return!1;return!0}function gn(r,e){for(let i=0,s=e.length;i<s;i++)r[i]=e[i]}function lu(r,e){let i=Iv[e];i===void 0&&(i=new Int32Array(e),Iv[e]=i);for(let s=0;s!==e;++s)i[s]=r.allocateTextureUnit();return i}function jw(r,e){const i=this.cache;i[0]!==e&&(r.uniform1f(this.addr,e),i[0]=e)}function Xw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2f(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(mn(i,e))return;r.uniform2fv(this.addr,e),gn(i,e)}}function Ww(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3f(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else if(e.r!==void 0)(i[0]!==e.r||i[1]!==e.g||i[2]!==e.b)&&(r.uniform3f(this.addr,e.r,e.g,e.b),i[0]=e.r,i[1]=e.g,i[2]=e.b);else{if(mn(i,e))return;r.uniform3fv(this.addr,e),gn(i,e)}}function qw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(mn(i,e))return;r.uniform4fv(this.addr,e),gn(i,e)}}function Yw(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(mn(i,e))return;r.uniformMatrix2fv(this.addr,!1,e),gn(i,e)}else{if(mn(i,s))return;zv.set(s),r.uniformMatrix2fv(this.addr,!1,zv),gn(i,s)}}function Zw(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(mn(i,e))return;r.uniformMatrix3fv(this.addr,!1,e),gn(i,e)}else{if(mn(i,s))return;Bv.set(s),r.uniformMatrix3fv(this.addr,!1,Bv),gn(i,s)}}function Kw(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(mn(i,e))return;r.uniformMatrix4fv(this.addr,!1,e),gn(i,e)}else{if(mn(i,s))return;Fv.set(s),r.uniformMatrix4fv(this.addr,!1,Fv),gn(i,s)}}function Qw(r,e){const i=this.cache;i[0]!==e&&(r.uniform1i(this.addr,e),i[0]=e)}function Jw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2i(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(mn(i,e))return;r.uniform2iv(this.addr,e),gn(i,e)}}function $w(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3i(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(mn(i,e))return;r.uniform3iv(this.addr,e),gn(i,e)}}function eR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(mn(i,e))return;r.uniform4iv(this.addr,e),gn(i,e)}}function tR(r,e){const i=this.cache;i[0]!==e&&(r.uniform1ui(this.addr,e),i[0]=e)}function nR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2ui(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(mn(i,e))return;r.uniform2uiv(this.addr,e),gn(i,e)}}function iR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3ui(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(mn(i,e))return;r.uniform3uiv(this.addr,e),gn(i,e)}}function aR(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(mn(i,e))return;r.uniform4uiv(this.addr,e),gn(i,e)}}function sR(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l);let c;this.type===r.SAMPLER_2D_SHADOW?(Wh.compareFunction=i.isReversedDepthBuffer()?lp:op,c=Wh):c=W_,i.setTexture2D(e||c,l)}function rR(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture3D(e||Y_,l)}function oR(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTextureCube(e||Z_,l)}function lR(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture2DArray(e||q_,l)}function cR(r){switch(r){case 5126:return jw;case 35664:return Xw;case 35665:return Ww;case 35666:return qw;case 35674:return Yw;case 35675:return Zw;case 35676:return Kw;case 5124:case 35670:return Qw;case 35667:case 35671:return Jw;case 35668:case 35672:return $w;case 35669:case 35673:return eR;case 5125:return tR;case 36294:return nR;case 36295:return iR;case 36296:return aR;case 35678:case 36198:case 36298:case 36306:case 35682:return sR;case 35679:case 36299:case 36307:return rR;case 35680:case 36300:case 36308:case 36293:return oR;case 36289:case 36303:case 36311:case 36292:return lR}}function uR(r,e){r.uniform1fv(this.addr,e)}function fR(r,e){const i=kr(e,this.size,2);r.uniform2fv(this.addr,i)}function dR(r,e){const i=kr(e,this.size,3);r.uniform3fv(this.addr,i)}function hR(r,e){const i=kr(e,this.size,4);r.uniform4fv(this.addr,i)}function pR(r,e){const i=kr(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,i)}function mR(r,e){const i=kr(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,i)}function gR(r,e){const i=kr(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,i)}function vR(r,e){r.uniform1iv(this.addr,e)}function _R(r,e){r.uniform2iv(this.addr,e)}function xR(r,e){r.uniform3iv(this.addr,e)}function SR(r,e){r.uniform4iv(this.addr,e)}function yR(r,e){r.uniform1uiv(this.addr,e)}function MR(r,e){r.uniform2uiv(this.addr,e)}function bR(r,e){r.uniform3uiv(this.addr,e)}function ER(r,e){r.uniform4uiv(this.addr,e)}function TR(r,e,i){const s=this.cache,l=e.length,c=lu(i,l);mn(s,c)||(r.uniform1iv(this.addr,c),gn(s,c));let f;this.type===r.SAMPLER_2D_SHADOW?f=Wh:f=W_;for(let m=0;m!==l;++m)i.setTexture2D(e[m]||f,c[m])}function AR(r,e,i){const s=this.cache,l=e.length,c=lu(i,l);mn(s,c)||(r.uniform1iv(this.addr,c),gn(s,c));for(let f=0;f!==l;++f)i.setTexture3D(e[f]||Y_,c[f])}function wR(r,e,i){const s=this.cache,l=e.length,c=lu(i,l);mn(s,c)||(r.uniform1iv(this.addr,c),gn(s,c));for(let f=0;f!==l;++f)i.setTextureCube(e[f]||Z_,c[f])}function RR(r,e,i){const s=this.cache,l=e.length,c=lu(i,l);mn(s,c)||(r.uniform1iv(this.addr,c),gn(s,c));for(let f=0;f!==l;++f)i.setTexture2DArray(e[f]||q_,c[f])}function CR(r){switch(r){case 5126:return uR;case 35664:return fR;case 35665:return dR;case 35666:return hR;case 35674:return pR;case 35675:return mR;case 35676:return gR;case 5124:case 35670:return vR;case 35667:case 35671:return _R;case 35668:case 35672:return xR;case 35669:case 35673:return SR;case 5125:return yR;case 36294:return MR;case 36295:return bR;case 36296:return ER;case 35678:case 36198:case 36298:case 36306:case 35682:return TR;case 35679:case 36299:case 36307:return AR;case 35680:case 36300:case 36308:case 36293:return wR;case 36289:case 36303:case 36311:case 36292:return RR}}class NR{constructor(e,i,s){this.id=e,this.addr=s,this.cache=[],this.type=i.type,this.setValue=cR(i.type)}}class DR{constructor(e,i,s){this.id=e,this.addr=s,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=CR(i.type)}}class UR{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,i,s){const l=this.seq;for(let c=0,f=l.length;c!==f;++c){const m=l[c];m.setValue(e,i[m.id],s)}}}const Jd=/(\w+)(\])?(\[|\.)?/g;function Hv(r,e){r.seq.push(e),r.map[e.id]=e}function LR(r,e,i){const s=r.name,l=s.length;for(Jd.lastIndex=0;;){const c=Jd.exec(s),f=Jd.lastIndex;let m=c[1];const g=c[2]==="]",h=c[3];if(g&&(m=m|0),h===void 0||h==="["&&f+2===l){Hv(i,h===void 0?new NR(m,r,e):new DR(m,r,e));break}else{let S=i.map[m];S===void 0&&(S=new UR(m),Hv(i,S)),i=S}}}class Qc{constructor(e,i){this.seq=[],this.map={};const s=e.getProgramParameter(i,e.ACTIVE_UNIFORMS);for(let f=0;f<s;++f){const m=e.getActiveUniform(i,f),g=e.getUniformLocation(i,m.name);LR(m,g,this)}const l=[],c=[];for(const f of this.seq)f.type===e.SAMPLER_2D_SHADOW||f.type===e.SAMPLER_CUBE_SHADOW||f.type===e.SAMPLER_2D_ARRAY_SHADOW?l.push(f):c.push(f);l.length>0&&(this.seq=l.concat(c))}setValue(e,i,s,l){const c=this.map[i];c!==void 0&&c.setValue(e,s,l)}setOptional(e,i,s){const l=i[s];l!==void 0&&this.setValue(e,s,l)}static upload(e,i,s,l){for(let c=0,f=i.length;c!==f;++c){const m=i[c],g=s[m.id];g.needsUpdate!==!1&&m.setValue(e,g.value,l)}}static seqWithValue(e,i){const s=[];for(let l=0,c=e.length;l!==c;++l){const f=e[l];f.id in i&&s.push(f)}return s}}function Gv(r,e,i){const s=r.createShader(e);return r.shaderSource(s,i),r.compileShader(s),s}const OR=37297;let PR=0;function IR(r,e){const i=r.split(`
`),s=[],l=Math.max(e-6,0),c=Math.min(e+6,i.length);for(let f=l;f<c;f++){const m=f+1;s.push(`${m===e?">":" "} ${m}: ${i[f]}`)}return s.join(`
`)}const Vv=new ut;function FR(r){Mt._getMatrix(Vv,Mt.workingColorSpace,r);const e=`mat3( ${Vv.elements.map(i=>i.toFixed(4))} )`;switch(Mt.getTransfer(r)){case $c:return[e,"LinearTransferOETF"];case Ft:return[e,"sRGBTransferOETF"];default:return at("WebGLProgram: Unsupported color space: ",r),[e,"LinearTransferOETF"]}}function kv(r,e,i){const s=r.getShaderParameter(e,r.COMPILE_STATUS),c=(r.getShaderInfoLog(e)||"").trim();if(s&&c==="")return"";const f=/ERROR: 0:(\d+)/.exec(c);if(f){const m=parseInt(f[1]);return i.toUpperCase()+`

`+c+`

`+IR(r.getShaderSource(e),m)}else return c}function BR(r,e){const i=FR(e);return[`vec4 ${r}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}const zR={[v_]:"Linear",[__]:"Reinhard",[x_]:"Cineon",[S_]:"ACESFilmic",[M_]:"AgX",[b_]:"Neutral",[y_]:"Custom"};function HR(r,e){const i=zR[e];return i===void 0?(at("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Vc=new oe;function GR(){Mt.getLuminanceCoefficients(Vc);const r=Vc.x.toFixed(4),e=Vc.y.toFixed(4),i=Vc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function VR(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Zo).join(`
`)}function kR(r){const e=[];for(const i in r){const s=r[i];s!==!1&&e.push("#define "+i+" "+s)}return e.join(`
`)}function jR(r,e){const i={},s=r.getProgramParameter(e,r.ACTIVE_ATTRIBUTES);for(let l=0;l<s;l++){const c=r.getActiveAttrib(e,l),f=c.name;let m=1;c.type===r.FLOAT_MAT2&&(m=2),c.type===r.FLOAT_MAT3&&(m=3),c.type===r.FLOAT_MAT4&&(m=4),i[f]={type:c.type,location:r.getAttribLocation(e,f),locationSize:m}}return i}function Zo(r){return r!==""}function jv(r,e){const i=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Xv(r,e){return r.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const XR=/^[ \t]*#include +<([\w\d./]+)>/gm;function qh(r){return r.replace(XR,qR)}const WR=new Map;function qR(r,e){let i=ft[e];if(i===void 0){const s=WR.get(e);if(s!==void 0)i=ft[s],at('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,s);else throw new Error("Can not resolve #include <"+e+">")}return qh(i)}const YR=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Wv(r){return r.replace(YR,ZR)}function ZR(r,e,i,s){let l="";for(let c=parseInt(e);c<parseInt(i);c++)l+=s.replace(/\[\s*i\s*\]/g,"[ "+c+" ]").replace(/UNROLLED_LOOP_INDEX/g,c);return l}function qv(r){let e=`precision ${r.precision} float;
...
#define LOW_PRECISION`),e}const KR={[Wc]:"SHADOWMAP_TYPE_PCF",[Yo]:"SHADOWMAP_TYPE_VSM"};function QR(r){return KR[r.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const JR={[Ps]:"ENVMAP_TYPE_CUBE",[Pr]:"ENVMAP_TYPE_CUBE",[su]:"ENVMAP_TYPE_CUBE_UV"};function $R(r){return r.envMap===!1?"ENVMAP_TYPE_CUBE":JR[r.envMapMode]||"ENVMAP_TYPE_CUBE"}const eC={[Pr]:"ENVMAP_MODE_REFRACTION"};function tC(r){return r.envMap===!1?"ENVMAP_MODE_REFLECTION":eC[r.envMapMode]||"ENVMAP_MODE_REFLECTION"}const nC={[g_]:"ENVMAP_BLENDING_MULTIPLY",[XE]:"ENVMAP_BLENDING_MIX",[WE]:"ENVMAP_BLENDING_ADD"};function iC(r){return r.envMap===!1?"ENVMAP_BLENDING_NONE":nC[r.combine]||"ENVMAP_BLENDING_NONE"}function aC(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,s=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),7*16)),texelHeight:s,maxMip:i}}function sC(r,e,i,s){const l=r.getContext(),c=i.defines;let f=i.vertexShader,m=i.fragmentShader;const g=QR(i),h=$R(i),_=tC(i),S=iC(i),v=aC(i),M=VR(i),b=kR(c),C=l.createProgram();let y,x,N=i.glslVersion?"#version "+i.glslVersion+`
