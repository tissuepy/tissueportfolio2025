            ...
            <div>
              ...
              {[
                ...
                <div key={company} style={{ display: 'flex', alignItems: 'baseline', padding: '5px 0' }}>
                  <span style={{ fontFamily: "'Geist Mono', monospace", fontSize: '15px', fontWeight: 400, color: 'rgba(50, 64, 79, 0.45)', width: '44px', flexShrink: 0 }}>{year}</span>
                  ...
                  <span style={{ fontFamily: "'Geist Variable', 'Geist', ui-sans-serif, system-ui, sans-serif", fontSize: '15px', fontWeight: 350, color: '#AAAAAA', textAlign: 'right' }}>{role}</span>
                </div>
              ))}
            </div>
          </div>
